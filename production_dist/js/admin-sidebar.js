document.addEventListener('DOMContentLoaded', () => {
    ...
    const navItems = [
        ...
        { name: 'Merchandise', icon: 'fas fa-tshirt', link: 'merchandise.html' },
        { name: 'Merch Orders', icon: 'fas fa-box-open', link: 'orders.html' },
        { name: 'Customer Reviews', icon: 'fas fa-star', link: 'reviews.html' },
