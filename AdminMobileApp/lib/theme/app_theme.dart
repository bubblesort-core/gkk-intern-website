...
class AppTheme {
  // Brand Colors — dark neon admin palette
  static const Color primary = Color(0xFF10B981); // Emerald green
  static const Color primaryHover = Color(0xFF0D9488); // Teal
  static const Color accent = Color(0xFFF59E0B); // Amber — admin accent
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: GoogleFonts.inter(color: textBody, fontSize: 12),
