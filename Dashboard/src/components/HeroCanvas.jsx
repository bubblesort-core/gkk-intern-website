...
const HeroCanvas = () => {
    ...
    useEffect(() => {
        ...
        parent.addEventListener('mousemove', hover);
        ...
        return () => {
            ...
            parent.removeEventListener('mousemove', hover);
    ...
    return <canvas ref={canvasRef} style={{ pointerEvents: 'none', position: 'absolute', inset: 0, width: '100%', height: '100%', zIndex: 0 }} />;
};
