...
export default function CallToAction() {
    ...
    return (
        <>
            ...
            <section id="apply" className="relative min-h-screen flex items-center justify-center bg-[#E5E5E5]">
                ...
                <div className="relative z-10 w-full max-w-[90vw] mx-auto text-center">
                    ...
                    >
                        <div className="overflow-hidden">
                            <motion.h2 variants={letterAnim} className="text-4xl md:text-8xl font-black font-inter tracking-tighter mb-4 text-[#1a1a1a]">
                                JOIN THE
                            </motion.h2>
                        </div>
                        ...
                        <div className="overflow-hidden relative">
                            <motion.h2
                                variants={letterAnim}
                                className="text-[80px] md:text-[240px] leading-[0.85] font-black font-inter tracking-tighter text-black uppercase"
                            >
                                GKK
                            </motion.h2>
                            {/* Decorative line */}
                            <motion.div
                                ...
                                className="absolute bottom-2 left-0 w-full h-2 md:h-4 bg-black origin-left"
                            />
                        </div>

                        <motion.p
                            variants={letterAnim}
                            className="text-base md:text-3xl font-cormorant italic text-black/80 max-w-2xl mx-auto mt-8 md:mt-12 font-medium"
                        >
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Button */}
                            <div className="relative bg-[#fff] px-10 py-5 md:px-16 md:py-8 border-2 border-black transition-all">
                    ...
                    <motion.div
                        ...
                        className="mt-6"
                    >
                        <a href="/Dashboard/user/signup.html" className="text-neutral-500 text-sm font-medium hover:text-black transition-colors border-b border-transparent hover:border-black pb-0.5">
