...
export default function Home() {
    ...
    const scrollToSection = (index: number) => {
        if (containerRef.current) {
            ...
            if (targetId) {
                const element = containerRef.current.querySelector(`#${targetId}`) as HTMLElement;
                if (element) {
                    containerRef.current.scrollTo({
    ...
    return (
        <>
            ...
            <section id="gkk-page-section" className="min-h-screen w-full relative">
                <GKKPage
            ...
            {/* About Section */}
            <section id="about-section" className="min-h-screen w-full relative">
                <AboutSection />
            </section>

            {/* Services Page */}
            <section id="services-section" className="min-h-screen w-full relative">
            ...
            <section id="achievement-section" className="min-h-screen w-full relative">
                <Suspense fallback={<SkeletonLoader />}>
                    <AchievementSection />
                </Suspense>
            </section>

            <section id="cta-section" className="min-h-screen w-full relative">
                <CallToAction />
            </section>

            <section id="contact-section" className="min-h-screen w-full relative">
                <Suspense fallback={<SkeletonLoader />}>
                    <ContactSection />
                </Suspense>
            </section>
