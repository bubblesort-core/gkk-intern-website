...
async function initiateTrainingPayment() {
    ...
    try {
        ...
        const response = await fetch('https://hjpsyxqakzrhvzegehtm.supabase.co/functions/v1/razorpay-order', {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                ...
                amount: 100 // Testing Amount: 100 paise = 1 INR
            })
        });
        ...
        const options = {
            ...
            name: "GKK INTERN",
            description: "Training Fee (₹1) + Gateway Charges",
            ...
            handler: async function (response) {
                ...
                try {
                    const verifyResp = await fetch('https://hjpsyxqakzrhvzegehtm.supabase.co/functions/v1/razorpay-verify', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
