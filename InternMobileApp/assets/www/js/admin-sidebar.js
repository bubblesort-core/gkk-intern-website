document.addEventListener('DOMContentLoaded', () => {
    ...
    const navItems = [
        ...
        { name: 'Live Meetings', icon: 'fas fa-video', link: 'meetings.html' },
        { name: 'Intern Support', icon: 'fas fa-headset', link: 'intern-support.html' },
    ...
    const sidebarContent = `
        <div class="sidebar-header">
            <div class="logo-text">
                <img src="../assets/gkk-intern-logo.png" alt="GKK-Hire" style="height: 60px; width: auto; vertical-align: middle;">
            </div>
        </div>
